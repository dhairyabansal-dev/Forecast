...
async def create_threat(
    ...
    threat = await service.create_threat(
        ...
        mitre_tactic=payload.mitre_tactic.value if payload.mitre_tactic else None,
        related_anomaly_ids=payload.related_anomaly_ids,
        iocs=payload.iocs,
    )
    return threat
...
async def list_threats(
    ...
    items, total = await service.list_threats(
        page=page,
        page_size=page_size,
        severity=severity,
