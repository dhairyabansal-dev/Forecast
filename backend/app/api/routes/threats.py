...
async def get_threat(threat_id: str, service: ThreatService = Depends(get_threat_service)):
...
async def update_threat(threat_id: str, payload: ThreatUpdate, service: ThreatService = Depends(get_threat_service)):
...
async def resolve_threat(threat_id: str, service: ThreatService = Depends(get_threat_service)):
...
async def delete_threat(threat_id: str, service: ThreatService = Depends(get_threat_service)):
